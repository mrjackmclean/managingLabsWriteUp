...
\title{\textbf{Managing Labs}\\codeHelper - Developing Lab Management Software for the New Normal}
...
\include{3requirements/doc}
\include{4ethics/doc}
\include{5analyse/doc}
\include{6swengprocess/doc}
\include{7design/doc}
\include{8implementation/doc}
\include{9testing/doc}
\include{10evaluation/doc}
\include{11conclusion/doc}
